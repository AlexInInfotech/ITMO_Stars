...
public class MobsCluster 
{
    ...
    {
        int seed = (int)((long)unitCoord.x.GetHashCode() * unitCoord.y.GetHashCode()*MobsManager.mobSeed % int.MaxValue);
        Debug.Log(seed);
        ...
        Debug.Log(unitCoord.x.GetHashCode() + " " + unitCoord.y.GetHashCode() + " " + MobsManager.mobSeed);
    }
}
